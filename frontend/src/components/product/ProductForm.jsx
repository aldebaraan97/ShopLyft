...
export default function ProductForm() {
  ...
  const [form, setForm] = useState({
    // id is usually generated by the backend; leave it out unless your API requires it
    name: "",
    description: "",
    price: "",
    stockQuantity: "",
  ...
  const { mutate, isPending, isSuccess } = useMutation({
    ...
    onSuccess: () => {
      // Refresh product list shown elsewhere: ['products']
  ...
  function handleSubmit(e) {
    ...
    // Cast numbers properly; inputs come in as strings
    const payload = {
      name: form.name.trim(),
        ...
        <div style={{ marginBottom: 12 }}>
          <label>
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Hot noodles within 5min"
              rows={3}
              style={{ display: "block", width: "100%", padding: 8, marginTop: 6 }}
            />
          </label>
        ...
        <div style={{ marginBottom: 16 }}>
          <label>
            ...
            >
              ...
              <option>Mains</option>
              <option>Soups & Noodles</option>
              <option>Desserts & Drinks</option>
              <option>Specials & Extras</option>
            </select>
          </label>
        </div>
